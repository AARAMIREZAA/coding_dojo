...
def user_show(id):
    ...
    return render_template('show_user.html', user=User.get_user_with_magazines(data))
...
def edit_user(id):
    ...
    return render_template("edit_user.html",user=User.get_user_with_magazines(data))
